...
Primary use cases:
  ...
  plan-to-jira      Add stories/tasks/sub-tasks from Spec Kit plans into Jira
                    Commands: find-parent, standard-tasks, generate-subtasks, push-subtasks
...
Common examples:
  ...
  speckit-jira-git standard-tasks --parent PROJ-123 --kinds specs-generation,specs-review,pr-review
  speckit-jira-git pr-to-jira --pr-url https://github.com/org/repo/pull/123 --event opened
  speckit-jira-git review-to-jira --pr-url https://github.com/org/repo/pull/123 --status approved --reviewer "Alice"
